...
def show_client_common():
    ...
    print "{}"
    print "void " + classname + "_client::wait_done()"
    print "{"
    ...
    print ONE_TEB + "is_conn = false;"
    print ONE_TEB + "lck.unlock();"
    print ONE_TEB + "wait_done();"
    print ONE_TEB + "lck.lock();"
...
def show_after_snd():
    print ONE_TEB + "if(err_report){__sync_add_and_fetch(&cb->cb_cnt, 1);__sync_add_and_fetch(&cb_ref_cnt, 1);}"
    print ONE_TEB + "AWE_MODULE_DEBUG(\"communicate snd\","
